...
Right now, I'm building [Ardent](https://ardent.ai), a platform which helps users blend the creativity of generative AI with the determinism of software, with the goal of helping anyone write software regardless of whether or not they know how to code. Before that, I spent a few years at [Stripe](https://stripe.com/), working on developer experience and some of the company's [early work with generative AI](https://openai.com/customer-stories/stripe).
