  ...
  return (
    <footer className="footer">
      ...
      <div className="content">
        <p>
          <Link to="/about">Nate Kohari</Link> is a software engineer and an entrepreneur. He lives and works in
        ...
        <ul className="pages">
          ...
          <li>
            <Link to="/career">My Work</Link>
          </li>
        </ul>
        <div className="bottom">
          <ul>
            <li>
              <a rel="external noopener noreferrer" href="https://github.com/nkohari" target="_blank">
            ...
            <li>
              <a rel="external noopener noreferrer" href="https://twitter.com/nkohari" target="_blank">
            ...
            <li>
              <a rel="external noopener noreferrer" href="https://linkedin.com/in/nkohari" target="_blank">
                <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="copyright">
            Copyright &copy; 2006-2019 Nate Kohari.
            <br />
            Licensed under{' '}
            <a
              className="license"
