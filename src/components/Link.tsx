...
export const LINK_CLASSES: Record<LinkType, string> = {
  ...
  spotify:
    'transition transition-all duration-200 hover:underline underline-offset-1 decoration-transparent hover:text-[#1db954] hover:decoration-[#1db954] dark:hover:text-[#1db954] dark:hover:decoration-[#1db954]',
  subtle:
