...
const SadComputer = ({ index, className }: SadComputerProps) => {
  const classes = classNames(`absolute h-full`, className);
  return (
    <motion.svg
      viewBox="0 0 100 100"
      variants={variants}
  ...
  return (
    <main className="flex-1 flex items-center justify-center">
      <div className="flex flex-col md:flex-row items-center">
        ...
        <div className="flex-1 text-center pt-8 md:text-left md:pl-28 md:pt-0">
          <div className="text-5xl font-extrabold pb-4">HTTP 404</div>
